...
└── tasks/
    ...
    ├── task-03-production-api/
        └── README.md              # production inference service guide

├── app/                           # FastAPI entry point
├── src/task3/                     # inference, validation, schemas, CLI, metrics
├── tests/                         # unit and API integration tests
├── config/                        # expectations and model registry metadata
├── Dockerfile
└── docker-compose.yml              # PostgreSQL + API + artifact storage
```
...
- [x] Task 3 — Production inference service
- [ ] Task 4 — Docker
- [ ] Task 5 — ETL Pipeline
